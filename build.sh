...
# Right
cd /workspaces/zmk-custom-sofle/app
west build --pristine=auto -d /workspaces/zmk-config/build-right -b nice_nano_v2 -- -DSHIELD="sofle_right nice_view_adapter nice_view" -DZMK_CONFIG="/workspaces/zmk-config/config"
